    ...
    <div class="phonebook">
      ...
      <div class="phonebook__table-wrapper">
        <table class="phonebook__table">
          ...
          <tbody v-for="department in getPhonebook" :key="department._id" v-show="department.show">
...
export default {
  ...
  methods: {
    ...mapMutations(['setPhonebook', 'setFilterPhonebook', 'resetFilterPhonebook']),
    filterPhones: function () {
      this.resetFilterPhonebook()

      if (this.searchTextLength >= 3) {
        this.setFilterPhonebook(this.searchText.toLowerCase())
      }
    }
  },
